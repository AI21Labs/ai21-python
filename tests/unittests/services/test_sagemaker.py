...
class TestSageMakerService:
    def test__get_model_package_arn__should_return_model_package_arn(self):
        expected_response = {
            "arn": _DUMMY_ARN,
            "versions": _DUMMY_VERSIONS,
        }
        SageMakerStub.ai21_http_client.execute_http_request.return_value = expected_response
